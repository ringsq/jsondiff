...
func ExampleCompare() {
	...
	// Output:
	// {"op":"replace","path":"/spec/containers/0/image","oldValue":"nginx:latest","value":"nginx:1.19.5-alpine"}
...
func ExampleCompareJSON() {
	...
	// Output:
	// {"op":"replace","path":"/age","oldValue":25,"value":30}
...
func ExampleInvertible() {
	...
	// {"op":"replace","path":"/a","oldValue":"1","value":"3"}
